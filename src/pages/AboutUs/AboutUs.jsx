                        ...
                        <Col>
                            <div className="about-panel">
                                <h3 className="title-w3l">
                                    <span>Meteo360 </span> — ზუსტი პროგნოზები<br/> და ინტერაქტიული რუკები
                                </h3>
                                <p className="about-lead">
                                    Meteo360 აერთიანებს სატელიტურ მონაცემებს, რადარსა და
                    ...
                    <div className="AboutWhy-grid">
                        ...
                        <div className="why-left">
                            ...
                            <p className="why-text">
                                Meteo360 გაძლევს ჰიპერლოკალურ პროგნოზებს, რადარის/სატელიტის ფენებსა და
                    ...
                    <Row gutter={[24, 24]} align="middle" wrap>
                        ...
                        <Col xs={24} md={12}>
                            <p className="vhny-para hero-copy">
                                Meteo360 აერთიანებს რადარს, სატელიტსა და მეტეოსადგურებს —
